...
parser.add_argument('-model', type=str, help='encoderfolder path to infer')
...
results = pd.DataFrame(columns=['cycle','accuracy','sensitivity','specificity','AUC_ROC'])
cycle_count=1



for i in range(17,18,1):
    model = tf.keras.models.load_model(args.model+str(i)+".h5")
